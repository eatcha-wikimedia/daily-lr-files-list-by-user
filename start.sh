...
~/lr-list-env/bin/python3 ~/daily-lr-files-list-by-user/gallery_audio_video.py -pt:0 -dir:~/daily-lr-files-list-by-user
~/lr-list-env/bin/python3 ~/daily-lr-files-list-by-user/gallery_image.py -pt:0 -dir:~/daily-lr-files-list-by-user
